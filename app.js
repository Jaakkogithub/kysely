...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var $async$goto = 0,
        ...
        kysymykset, t1, t2, $async$temp1, $async$temp2;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              t1 = document;
              t2 = t1.querySelector("#vastaukset");
              if (t2 != null)
                J.get$children$x(t2).clear$0(0);
              t1 = t1.querySelector("#kysymys");
              if (t1 != null)
                J.set$text$x(t1, "Klikkaa nappia aloittaaksesi.");
              A.aloita(kysymykset);
              // implicit return
    ...
    aloita(kysymykset) {
      ...
      if (t1 != null) {
        ...
        t2 = t1.$ti;
        A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(new A.aloita_closure(kysymykset)), false, t2._precomputed1);
      }
    },
    asetaKysymys(kysymys, kysymykset) {
      var t1 = J.getInterceptor$asx(kysymys),
        t2 = t1.$index(kysymys, "teksti"),
        t3 = document.querySelector("#kysymys");
      if (t3 != null)
        J.set$text$x(t3, A._asStringQ(t2));
      A.asetaVastausvaihtoehdot(t1.$index(kysymys, "vaihtoehdot"), kysymykset);
    },
    asetaVastausvaihtoehdot(vaihtoehdot, kysymykset) {
      ...
      for (t1 = J.getInterceptor$asx(vaihtoehdot), i = 0; i < A._asNum(t1.get$length(vaihtoehdot)); ++i)
        A.lisaaVastausvaihtoehto(t1.$index(vaihtoehdot, i), kysymykset);
    },
    lisaaVastausvaihtoehto(vaihtoehto, kysymykset) {
      var t3, t1 = {},
        t2 = document,
        elementti = t2.createElement("div");
      elementti.className = "vaihtoehto";
      B.DivElement_methods.set$text(elementti, A._asStringQ(J.$index$asx(vaihtoehto, "teksti")));
      t3 = t2.querySelector("#piste");
      t3 = t3 == null ? null : t3.textContent;
      t1.oikein = A.int_parse(t3 == null ? A._asString(t3) : t3);
      t3 = t2.querySelector("#paste");
      t3 = t3 == null ? null : t3.textContent;
      t1.pisteet = A.int_parse(t3 == null ? A._asString(t3) : t3);
      t3 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(elementti, "click", t3._eval$1("~(1)?")._as(new A.lisaaVastausvaihtoehto_closure(t1, vaihtoehto, elementti, kysymykset)), false, t3._precomputed1);
      t2 = t2.querySelector("#vastaukset");
      if (t2 != null)
        J.get$children$x(t2).add$1(0, elementti);
    },
    aloita_closure: function aloita_closure(t0) {
      this.kysymykset = t0;
    },
    lisaaVastausvaihtoehto_closure: function lisaaVastausvaihtoehto_closure(t0, t1, t2, t3) {
      var _ = this;
      _._box_0 = t0;
      _.vaihtoehto = t1;
      _.elementti = t2;
  ...
  A.aloita_closure.prototype = {
    call$1(e) {
      ...
      t2.shuffle$0(t1);
      A.asetaKysymys(t2.$index(t1, 0), t1);
    },
    $signature: 20
  };
  A.lisaaVastausvaihtoehto_closure.prototype = {
    call$1(e) {
      return this.$call$body$lisaaVastausvaihtoehto_closure(type$.MouseEvent._as(e));
    },
    $call$body$lisaaVastausvaihtoehto_closure(e) {
      var $async$goto = 0,
      ...
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.elementti;
              $async$goto = A._asBool(J.$index$asx($async$self.vaihtoehto, "oikein")) ? 2 : 4;
              break;
            case 2:
              // then
              B.DivElement_methods.set$text(t1, "oikein!");
              t1 = t1.style;
              t1.backgroundColor = "green";
              ...
              t3 = t2.querySelector("#piste");
              if (t3 != null)
                J.set$text$x(t3, B.JSInt_methods.toString$0(t1.oikein));
              t2 = t2.querySelector("#paste");
              if (t2 != null)
                J.set$text$x(t2, B.JSInt_methods.toString$0(t1.pisteet));
              $async$goto = 5;
              return A._asyncAwait(A.Future_Future$delayed(A.Duration$(2), type$.dynamic), $async$call$1);
            case 5:
              // returning from await.
              t1 = $async$self.kysymykset;
              t2 = J.getInterceptor$ax(t1);
              t2.shuffle$0(t1);
              A.asetaKysymys(t2.$index(t1, 0), t1);
              // goto join
            ...
            case 4:
              ...
              t1 = $async$self._box_0;
              ++t1.pisteet;
              t2 = document.querySelector("#paste");
              if (t2 != null)
                J.set$text$x(t2, B.JSInt_methods.toString$0(t1.pisteet));
              $async$goto = 6;
              return A._asyncAwait(A.Future_Future$delayed(A.Duration$(2), type$.dynamic), $async$call$1);
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A._CssStyleDeclaration_JavaScriptObject_CssStyleDeclarationBase, A.DomException, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin, A._NodeList_JavaScriptObject_ListMixin]);
